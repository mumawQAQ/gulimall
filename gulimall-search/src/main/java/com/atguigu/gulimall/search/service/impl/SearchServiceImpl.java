...
public class SearchServiceImpl implements SearchService {
	...
	private SearchResult buildSearchResult(SearchResponse response, SearchParam Param) {
		...
		// 总页码：计算得到
		Long pageNum = total % EsConstant.PRODUCT_PASIZE == 0 ? total / EsConstant.PRODUCT_PASIZE : total / EsConstant.PRODUCT_PASIZE + 1;
		result.setTotalPages(Math.toIntExact(pageNum));
		// 设置导航页
